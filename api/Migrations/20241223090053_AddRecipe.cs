    ...
    public partial class AddRecipe : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductInRecipes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductInRecipes_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductInRecipes_Recipes_RecipeId",
                        column: x => x.RecipeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductInRecipes_ProductId",
                table: "ProductInRecipes",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductInRecipes_RecipeId",
                table: "ProductInRecipes",
                column: "RecipeId");
